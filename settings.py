...
DATABASE_NAME = '/home/chris/genenews/db.db'             # Or path to database file if using sqlite3.
...
MEDIA_ROOT = '/home/chris/genenews/media/'
...
TEMPLATE_DIRS = (
    ...
    '/usr/lib/python2.7/site-packages/django/contrib/auth/tests/templates/',
)
